...
def main():
    with open("rt-polarity-sample.pos", "w") as sample_file, open("rt-polarity.pos", "r") as source_file:
        sample_file.writelines(sample(source_file.readlines()))

    with open("rt-polarity-sample.neg", "w") as sample_file, open("rt-polarity.neg", "r") as source_file:
        sample_file.writelines(sample(source_file.readlines()))
